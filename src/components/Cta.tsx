    ...
    <div className="relative py-32 px-10 lg:px-0">
      ...
      <div className="">
        <div className="justify-center flex flex-col items-center text-center max-w-2xs sm:max-w-2xl lg:max-w-3xl mx-auto px-2 lg:px-16 pt-5 pb-2 space-y-3 bg-white">
          ...
          <h2 className='text-lg text-black'>Rejoignez la meilleure plateforme d'Afrique pour des évènements réussis à chaque étape.</h2>
          <Link href="/publish" className="flex space-x-2 items-center rounded-xl py-3 px-4 md:px-8 text-white text-sm lg:text-lg font-medium bg-black ">

    ...
    <div className="bg-[#F5F5F5]">
      <div className="py-8 lg:py-20 flex flex-col items-center justify-center max-w-7xl gap-6 mx-auto px-4 lg:px-0 text-black ">
        <div className="max-w-4xl lg:max-w-2xl mx-auto py-4 lg:py-8">
          ...
          <h1 className="text-xl text-center mx-auto">Notre plateforme de billeterie en ligne rend la gestion d&apos;évènements simple, sécurisée et accessible à tous.</h1>
        </div>
        <div className="relative w-full ">
          <Image className="hidden md:block absolute z-10 top-0 md:-top-4 lg:-top-8 xl:-top-12" src={Courbe} alt="courbe"  height={1100} />
          <div className="flex flex-col sm:flex-row md:flex-nowrap md:gap-10 justify-center md:justify-between px-0  md:px-10 lg:px-10">
            ...
            <div className="flex flex-col mt-5 md:mt-0 pt-1 md:pt-7 lg:pt-10 xl:pt-8 z-20">
            ...
            <div className="flex flex-col mt-5 md:mt-0 pt-1 md:pt-7 lg:pt-9 xl:pt-5 z-20">

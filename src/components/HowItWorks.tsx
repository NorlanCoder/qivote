...
export default function HowItWorks() {
  return (
    <div className="py-8 lg:py-16  flex flex-col  items-center justify-center max-w-7xl gap-6 mx-auto px-4 lg:px-0 text-black ">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between px-0  md:px-10 lg:px-20">
            <div className="flex flex-col  ">
                ...
                <div className="max-w-44 lg:max-w-56 ">
                    <h1 className="font-bold text-sm  pb-1 ">Choississez un évènement, faites entendre votre voix</h1>
                    <p className="text-xs ">Parcourez les nominé.es par catégorie, explorez les prochaines étapes, suivez les participants et votez en toute simplicité.</p>
                </div>
            </div>
            <div className="flex flex-col pt-1 md:pt-7 lg:pt-10 xl:pt-12 ">
                <Image className="pb-2" src={Icone2} alt="icone2" width={50} height={50} />
                <div className="max-w-44 lg:max-w-56 ">
                    <h1 className="font-bold text-sm  pb-1 ">Votez pour vos favoris (individuellement ou en masse).</h1>
                    <p className="text-xs ">Notre scanner de billets dédié transforme votre téléphone en l'outil ultime pour des enregistrements rapides sans faille.</p>
                </div>
            </div>
            <div className="flex flex-col pt-1 md:pt-5 lg:pt-7 xl:pt-8">
                <Image className="pb-2" src={Icone3} alt="icone3" width={50} height={50} />
                <div className="max-w-44 lg:max-w-56 ">
                    <h1 className="font-bold text-sm pb-1 ">Suivez les résultats en temps réel et partagez!</h1>
                    <p className="text-xs ">Grâce à notre système de paiement fiable, vous et vos clients bénéficiez d'une expérience de paiement universelle.</p>
                </div>
            </div>
        </div>
